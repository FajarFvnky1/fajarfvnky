...
const instagram = 'https://www.instagram.com/fajarz01/'; 
const telegram = 'GAK PUNYA'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/channel/UCE1voV6YJvAEr9hRHEvHc1g';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@fajarz01')
